...
/* ------------------------------------------------------------ */
/**
 * Dynamic Servlet Invoker. This servlet invokes anonymous servlets that have not been defined in the web.xml
 * or by other means. The first element of the pathInfo of a request passed to the envoker is treated as a
 * servlet name for an existing servlet, or as a class name of a new servlet. This servlet is normally mapped
 * to /servlet/* This servlet support the following initParams:
 * <PRE>
