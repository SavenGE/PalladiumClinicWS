 ...
 * Servlet Context.
 * <p>
 * This extension to the ContextHandler allows for simple construction of a context with ServletHandler and
 * optionally session and security handlers, et.
 * <pre>
...
public class ServletContextHandler extends ContextHandler
{
     ...
     * @return the set of exact URL mappings currently associated with the registration that are also present
     * in the web.xml security constraints and thus will be unaffected by this call.
     */
     ...
     * getAttribute("org.eclipse.jetty.util.DecoratedObjectFactory") or {@link #getObjectFactory()} instead
     */
    @Deprecated
