 ...
 * interface. This class will organise the loading of the servlet when needed or requested.
 */
...
public class ServletHolder extends Holder<Servlet> implements UserIdentity.Scope, Comparable<ServletHolder>
{
     ...
     * <p>
     * Holders with order&lt;0, are initialized on use. Those with order&gt;=0 are initialized in increasing
     * order when the handler is started.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Check if there is a javax.servlet.annotation.ServletSecurity annotation on the servlet class. If there
     * is, then we force it to be loaded on startup, because all of the security constraints must be
     * calculated as the container starts.
     *
     */
