...
/**
 * <p>
 * {@link ManagedSelector} wraps a {@link Selector} simplifying non-blocking operations on channels.</p>
 * <p>
 * {@link ManagedSelector} runs the select loop, which waits on {@link Selector#select()} until events happen
 * for registered channels. When events happen, it notifies the {@link EndPoint} associated with the
 * channel.</p>
 */
public class ManagedSelector extends AbstractLifeCycle implements Runnable, Dumpable
{
    ...
    /**
     * A {@link SelectableEndPoint} is an {@link EndPoint} that wish to be notified of non-blocking events by
     * the {@link ManagedSelector}.
     */
    public interface SelectableEndPoint extends EndPoint
    {
         ...
         * {@link ManagedSelector} for this endpoint.
         *
        ...
        /**
         * Callback method invoked when all the keys selected by the {@link ManagedSelector} for this endpoint
         * have been processed.
         */
        void updateKey();
    }
