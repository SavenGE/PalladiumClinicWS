...
/**
 * <p>
 * {@link SelectorManager} manages a number of {@link ManagedSelector}s that simplify the non-blocking
 * primitives provided by the JVM via the {@code java.nio} package.</p>
 * <p>
 * {@link SelectorManager} subclasses implement methods to return protocol-specific {@link EndPoint}s and
 * {@link Connection}s.</p>
 */
public abstract class SelectorManager extends AbstractLifeCycle implements Dumpable
{
     ...
     * <p>
     * The channel must be set in non-blocking mode, {@link SocketChannel#connect(SocketAddress)} must be
     * called prior to calling this method, and the connect operation must not be completed (the return value
     * of {@link SocketChannel#connect(SocketAddress)} must be false).</p>
     *
    ...
    /**
     * <p>
     * Registers a server channel for accept operations. When a {@link SocketChannel} is accepted from the
     * given {@link ServerSocketChannel} then the {@link #accepted(SocketChannel)} method is called, which
     * must be overridden by a derivation of this class to handle the accepted channel
     *
    ...
    /**
     * Callback method when a channel is accepted from the {@link ServerSocketChannel} passed to
     * {@link #acceptor(ServerSocketChannel)}. The default impl throws an
     * {@link UnsupportedOperationException}, so it must be overridden by subclasses if a server channel is
     * provided.
     *
     * @param channel the
    ...
    /**
     * <p>
     * Callback method invoked when a non-blocking connect cannot be completed.</p>
     * <p>
     ...
     * {@link #connect(SocketChannel, Object)} or {@link #accept(SocketChannel)}.</p>
     *
