 ...
 *
 * <p>
 * This class is not synchronized as it is expected that modifications will only be performed by a single
 * thread.
 *
 * <p>
...
public class HttpFields implements Iterable<HttpField>
{
    ...
    /**
     * Get enumeration of header _names. Returns an enumeration of strings representing the header _names for
     * this request.
     *
    ...
    /**
     * Get multi field values with separator. The multiple values can be represented as separate headers of
     * the same name, or by a single header using the separator(s), or a combination of both. Separators may
     * be quoted.
     *
     * @param name the case-insensitive field name
    ...
    /**
     * Add to or set a field. If the field is allowed to have multiple values, add will add multiple headers
     * of the same name.
     *
     * @param name the name of the field
    ...
    /**
     * Get a header as an long value. Returns the value of an integer field or -1 if not found. The case of
    ...
    /**
     * Get a header as a date value. Returns the value of a date field, or -1 if not found. The case of the
    ...
    /**
     * Add fields from another HttpFields instance. Single valued fields are replaced, while all others are
     * added.
     *
    ...
    /**
     * Get field value parameters. Some field values can have parameters. This method separates the value from
     * the parameters and optionally populates a map with the parameters. For example:
     *
     * <PRE>
     *
