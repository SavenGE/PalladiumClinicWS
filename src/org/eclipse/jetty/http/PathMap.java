 ...
 *
 * <p>
 * Multiple path specifications can be mapped by providing a list of specifications. By default this class
 * uses characters ":," as path separators, unless configured differently by calling the static method @see
 * PathMap#setPathSpecSeparators(String)
 * <p>
 * Special characters within paths such as '?� and ';' are not treated specially as it is assumed they would
 * have been either encoded in the original URL or stripped from the path.
 * <p>
 * This class is not synchronized. If concurrent modifications are possible then it should be synchronized at
 * a higher level.
 *
...
public class PathMap<O> extends HashMap<String, O>
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the path spec separator. Multiple path specification may be included in a single string if they are
     * separated by the characters set in this string. By default this class uses ":," characters as path
     * separators.
     *
     * @param s separators
     */
