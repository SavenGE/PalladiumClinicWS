 ...
 */
public class HttpExchangeDelegate extends com.sun.net.httpserver.HttpExchange
{
    ...
    HttpExchangeDelegate(HttpContext jaxWsContext, HttpServletRequest req, HttpServletResponse resp)
    {
