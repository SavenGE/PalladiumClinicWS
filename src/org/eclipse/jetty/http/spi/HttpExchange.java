...
public class HttpExchange extends com.sun.net.httpserver.HttpExchange implements Exchange
{
    private HttpExchangeDelegate _delegate;

    public HttpExchange(HttpContext jaxWsContext, HttpServletRequest req, HttpServletResponse resp)
    {
        super();
