...
public class HttpSpiContextHandler extends ContextHandler
{
    ...
    public void doScope(String target, Request baseRequest, HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException
    {
        ...
        com.sun.net.httpserver.HttpExchange jettyHttpExchange;
        if (baseRequest.isSecure())
        {
            jettyHttpExchange = new HttpsExchange(_httpContext, req, resp);
        }
        else
        {
            jettyHttpExchange = new HttpExchange(_httpContext, req, resp);
        }
    ...
    private void handleAuthentication(HttpServletResponse resp, com.sun.net.httpserver.HttpExchange httpExchange, Authenticator auth) throws IOException
    {
        ...
        else if (result instanceof Authenticator.Success)
        {
            ...
            ((Exchange) httpExchange).setPrincipal(principal);
