...
/**
 */
public class HttpsExchange extends com.sun.net.httpserver.HttpsExchange implements Exchange
{
    private HttpExchangeDelegate _delegate;

    public HttpsExchange(HttpContext jaxWsContext, HttpServletRequest req, HttpServletResponse resp)
    {
        super();
        _delegate = new HttpExchangeDelegate(jaxWsContext, req, resp);
    }
