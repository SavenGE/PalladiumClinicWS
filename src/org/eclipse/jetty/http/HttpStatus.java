...
public class HttpStatus
{
    ...
    public enum Code
    {
        ...
        /**
         * Simple test against an code to determine if it falls into the <code>Informational</code> message
         * category as defined in the <a
         * href="http://tools.ietf.org/html/rfc1945">RFC 1945 - HTTP/1.0</a>, and
        ...
        /**
         * Simple test against an code to determine if it falls into the <code>Success</code> message category
         * as defined in the <a
         * href="http://tools.ietf.org/html/rfc1945">RFC 1945 - HTTP/1.0</a>, and
         * <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
         *
        ...
        /**
         * Simple test against an code to determine if it falls into the <code>Redirection</code> message
         * category as defined in the <a
         * href="http://tools.ietf.org/html/rfc1945">RFC 1945 - HTTP/1.0</a>, and
         * <a href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
         *
    ...
    /**
     * Simple test against an code to determine if it falls into the <code>Success</code> message category as
     * defined in the <a
     * href="http://tools.ietf.org/html/rfc1945">RFC 1945 - HTTP/1.0</a>, and <a
     * href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
     *
    ...
    /**
     * Simple test against an code to determine if it falls into the <code>Redirection</code> message category
     * as defined in the <a
     * href="http://tools.ietf.org/html/rfc1945">RFC 1945 - HTTP/1.0</a>, and <a
     * href="http://tools.ietf.org/html/rfc7231">RFC 7231 - HTTP/1.1</a>.
     *
