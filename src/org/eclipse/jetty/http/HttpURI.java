 ...
 * <code>http://user@host:port/path/info;param?query#fragment</code> this class will split it into the
 * following undecoded optional elements:<ul>
 ...
 *
 * <p>
 * Any parameters will be returned from {@link #getPath()}, but are excluded from the return value of
 * {@link #getDecodedPath()}. If there are multiple parameters, the {@link #getParam()} method returns only
 * the last one.
 */
