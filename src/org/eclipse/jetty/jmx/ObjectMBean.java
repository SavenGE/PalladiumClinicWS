 ...
 * ObjectMBean.
 * <p>
 * A dynamic MBean that can wrap an arbitary Object instance. the attributes and methods exposed by this bean
 * are controlled by the merge of property bundles discovered by names related to all superclasses and all
 * superinterfaces.
 * <p>
 * Attributes and methods exported may be "Object" and must exist on the wrapped object, or "MBean" and must
 * exist on a subclass of OBjectMBean or "MObject" which exists on the wrapped object, but whose values are
...
public class ObjectMBean implements DynamicMBean
{
    ...
    private static Class<?>[] OBJ_ARG = new Class[]
    {
        Object.class
    };
    ...
    /* ------------------------------------------------------------ */
    /**
     * Create MBean for Object. Attempts to create an MBean for the object by searching the package and class
     * name space. For example an object of the type
     *
     * <PRE>
            ...
            while (mbean == null && oClass != null)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        mbean = constructor.newInstance(new Object[]
                        {
                            o
                        });
                    }
     ...
     *
     * Define an attribute on the managed object. The meta data is defined by looking for standard getter and
     * setter methods. Descriptions are obtained with a call to findDescription with the attribute name.
     *
     * @param method the method to define
     * @param attributeAnnotation "description" or "access:description" or "type:access:description" where
     * type is one of: <ul>
     * <li>"Object" The field/method is on the managed object.
     * <li>"MBean" The field/method is on the mbean proxy object
     * <li>"MObject" The field/method is on the managed object and value should be converted to MBean
     * reference
     * <li>"MMBean" The field/method is on the mbean proxy object and value should be converted to MBean
     * reference
     * </ul>
     ...
     * TODO update to new behavior
     *
     * Define an operation on the managed object. Defines an operation with parameters. Refection is used to
     * determine find the method and it's return type. The description of the method is found with a call to
     * findDescription on "name(signature)". The name and description of each parameter is found with a call
     * to findDescription with "name(signature)[n]", the returned description is for the last parameter of the
     * partial signature and is assumed to start with the parameter name, followed by a colon.
     *
     * @param metaData "description" or "impact:description" or "type:impact:description", type is the
     * "Object","MBean", "MMBean" or "MObject" to indicate the method is on the object, the MBean or on the
     * object but converted to an MBean reference, and impact is either "ACTION","INFO","ACTION_INFO" or
     * "UNKNOWN".
     */
