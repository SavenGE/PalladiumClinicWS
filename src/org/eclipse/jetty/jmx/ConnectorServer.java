...
public class ConnectorServer extends AbstractLifeCycle
{
     ...
     *
     * @param serviceURL the address of the new connector server. The actual address of the new connector
     ...
     * Constructs connector server
     *
     * @param svcUrl the address of the new connector server. The actual address of the new connector server,
     * as returned by its getAddress method, will not necessarily be exactly the same.
     * @param environment a set of attributes to control the new connector server's behavior. This parameter
     * can be null. Keys in this map must be Strings. The appropriate type of each associated value depends on
    ...
    /**
     * Check that local RMI registry is used, and ensure it is started. If local RMI registry is being used
     * and not started, start it.
     *
