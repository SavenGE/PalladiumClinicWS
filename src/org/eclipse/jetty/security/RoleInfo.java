 ...
 * RoleInfo
 *
 * Badly named class that holds the role and user data constraint info for a path/http method combination,
 * extracted and combined from security constraints.
 *
