...
public interface ConstraintAware
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add a Constraint Mapping. May be called for running webapplication as an annotated servlet is
     * instantiated.
     *
     * @param mapping
     */
    ...
    /**
     * See Servlet Spec 31, sec 13.8.4, pg 145 When true, requests with http methods not explicitly covered
     * either by inclusion or omissions in constraints, will have access denied.
     *
     * @param deny
     */
    ...
    /**
     * See Servlet Spec 31, sec 13.8.4, pg 145 Container must check if there are urls with uncovered http
     * methods
     *
