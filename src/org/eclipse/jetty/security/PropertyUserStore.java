 ...
 * PropertyUserStore
 * <p>
 * This class monitors a property file of the format mentioned below and notifies registered listeners of the
 * changes to the the given file.
 *
 * <pre>
 *  username: password [,rolename ...]
 * </pre>
 *
 * Passwords may be clear text, obfuscated or checksummed. The class com.eclipse.Util.Password should be used
...
public class PropertyUserStore extends AbstractLifeCycle implements PathWatcher.Listener
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Depending on the value of the refresh interval, this method will either start up a scanner thread that
     * will monitor the properties file for changes after it has initially loaded it. Otherwise the users will
     * be loaded and there will be no active monitoring thread so changes will not be detected.
     *
     *
