 ...
 * <p>
 * Typically these maps are populated by calling the load() method or passing a properties resource to the
 * constructor. The format of the properties file is:
 *
 * <pre>
...
public class HashLoginService extends MappedLoginService implements UserListener
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Load realm users from properties file. The property file maps usernames to password specs followed by
