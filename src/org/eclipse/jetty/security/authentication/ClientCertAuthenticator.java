...
public class ClientCertAuthenticator extends LoginAuthenticator
{
     ...
     *
     * Required for integrations to be able to override the mechanism used to load a keystore in order to
     ...
     * @return a (possibly empty) collection view of java.security.cert.CRL objects initialized with the data
