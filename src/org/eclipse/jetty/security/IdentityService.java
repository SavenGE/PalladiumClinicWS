...
public interface IdentityService
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Associate a user identity with the current thread. This is called with as a thread enters the
    ...
    /* ------------------------------------------------------------ */
    /**
     * Create a new UserIdentity for use with this identity service. The UserIdentity should be immutable and
     * able to be cached.
     *
     * @param subject Subject to include in UserIdentity
     * @param userPrincipal Principal to include in UserIdentity. This will be returned from getUserPrincipal
     * calls
