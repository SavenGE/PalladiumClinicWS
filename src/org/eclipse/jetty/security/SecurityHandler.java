 ...
 * a call to either the default or set AuthenticatorFactory.
 * <p>
 * SecurityHandler has a set of initparameters that are used by the Authentication.Configuration. At startup,
 * any context init parameters that start with "org.eclipse.jetty.security." that do not have values in the
...
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration
{
     ...
     * <p>
     * If set to true, then on authentication, the session associated with a reqeuest is invalidated and
 ...
 /* ------------------------------------------------------------ */
    /**
     * Nobody user. The Nobody UserPrincipal is used to indicate a partial state of authentication. A request
     * with a Nobody UserPrincipal will be allowed past all authentication constraints - but will not be
     * considered an authenticated request. It can be used by Authenticators such as FormAuthenticator to
     * allow access to logon and error pages within an authenticated URI tree.
     */
