 ...
 * Scanner
 *
 * Utility for scanning a directory for added, removed and changed files and reporting these events via
...
public class Scanner extends AbstractLifeCycle
{
     ...
     *
     * @param reportExisting if true, all files found on initial scan will be reported as being added,
     * otherwise not
     */
