...
/**
 * A concurrent, unbounded implementation of {@link Queue} that uses singly-linked array blocks to store
 * elements.
 * <p>
 * This class is a drop-in replacement for {@link ConcurrentLinkedQueue}, with similar performance but
 * producing less garbage because arrays are used to store elements rather than nodes.
 * </p>
 * <p>
