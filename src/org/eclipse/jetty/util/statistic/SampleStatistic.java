 ...
 * <p>
 * Calculates estimates of mean, variance, and standard deviation characteristics of a sample using a non
 * synchronized approximation of the on-line algorithm presented in <cite>Donald Knuth's Art of Computer
 * Programming, Volume 2, Seminumerical Algorithms, 3rd edition, page 232, Boston: Addison-Wesley</cite>. that
 * cites a 1962 paper by B.P. Welford that can be found by following
 * <a href="http://www.jstor.org/pss/1266577">Note on a Method for Calculating Corrected Sums of Squares and
 * Products</a>
 * <p>
