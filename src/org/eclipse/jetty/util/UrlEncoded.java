 ...
 * <p>
 * This class handles the encoding and decoding for either the query string of a URL or the _content of a POST
 * HTTP request.
 * </p>
 * <b>Notes</b>
 * <p>
 * The UTF-8 charset is assumed, unless otherwise defined by either passing a parameter or setting the
 * "org.eclipse.jetty.util.UrlEncoding.charset" System property.
 * </p>
 * <p>
 * The hashtable either contains String single values, vectors of String or arrays of Strings.
 * </p>
 * <p>
 * This class is only partially synchronised. In particular, simple get operations are not protected from
 * concurrent updates.
 * </p>
 *
...
public class UrlEncoded extends MultiMap<String> implements Cloneable
{
     ...
     * @param equalsForNullValue if True, then an '=' is always used, even for parameters without a value.
     * e.g. <code>"blah?a=&amp;b=&amp;c="</code>.
     * @return the MultiMap as a string encoded with % encodings
     */
    ...
    /* -------------------------------------------------------------- */
    /**
     * Decode String with % encoding. This method makes the assumption that the majority of calls will need no
     * decoding.
     *
