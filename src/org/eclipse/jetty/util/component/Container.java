...
public interface Container
{
    ...
    /**
     * Removes the given bean. If the bean is-a {@link Listener}, then also do an implicit
     * {@link #removeEventListener(Listener)}.
     *
    ...
    /**
     * A listener for Container events. If an added bean implements this interface it will receive the events
     * for this container.
     */
    ...
    /**
     * Inherited Listener. If an added bean implements this interface, then it will be added to all contained
     * beans that are themselves Containers
     */
