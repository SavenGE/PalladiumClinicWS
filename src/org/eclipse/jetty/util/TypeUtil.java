...
public class TypeUtil
{
        ...
        throws InvocationTargetException, NoSuchMethodException
    {
        ...
        for (Method method : oClass.getMethods())
        {
            ...
            {
                args_with_opts = ArrayUtil.addToArray(arg, new Object[]
                {
                }, Object.class);
            }
            try
     ...
     * @return True if passed object is not null and is either a Boolean with value true or evaluates to a
     ...
     * @return True if passed object is not null and is either a Boolean with value false or evaluates to a
     * string that evaluates to false.
     */
