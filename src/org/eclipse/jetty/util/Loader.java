...
/* ------------------------------------------------------------ */
/**
 * ClassLoader Helper. This helper class allows classes to be loaded either from the Thread's
 * ContextClassLoader, the classloader of the derived class or the system ClassLoader.
 *
 * <B>Usage:</B><PRE>
