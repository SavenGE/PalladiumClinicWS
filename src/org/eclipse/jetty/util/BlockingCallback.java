...
public class BlockingCallback implements Callback
{
    ...
    /**
     * Blocks until the Callback has succeeded or failed and after the return leave in the state to allow
     * reuse. This is useful for code that wants to repeatable use a FutureCallback to convert an asynchronous
     * API to a blocking API.
     *
