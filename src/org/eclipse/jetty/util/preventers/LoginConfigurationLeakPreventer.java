 ...
 *
 * The javax.security.auth.login.Configuration class keeps a static reference to the thread context
 * classloader. We prevent a webapp context classloader being used for that by invoking the classloading here.
 *
