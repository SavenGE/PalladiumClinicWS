 ...
 * com.sun.jndi.ldap.connect.pool.timeout is set to a nonzero value, a daemon thread is started which can pin
 * a webapp classloader if it is the first to load the LdapPoolManager.
 *
