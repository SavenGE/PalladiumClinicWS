 ...
 *
 * This class is a copy of the java.util.StringTokenizer API and the behaviour is the same, except that single
 * and double quoted string values are recognised. Delimiters within quotes are not considered delimiters.
    ...
    extends StringTokenizer
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Quote a string. The string is quoted only if quoting is required due to embedded delimiters, quote
    ...
    /* ------------------------------------------------------------ */
    /**
     * Quote a string. The string is quoted only if quoting is required due to embeded delimiters, quote
     * characters or the empty string.
     *
     * @param s The string to quote.
     * @return quoted string
     ...
     *
     * @param s The string to unquote.
     * @param lenient true if unquoting should be lenient to escaped content, leaving some alone, false if
     * string unescaping
     * @return quoted string
     */
