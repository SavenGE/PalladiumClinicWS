 ...
 * URI Utility methods.
 * <p>
 * This class assists with the decoding and encoding or HTTP URI's. It differs from the java.net.URL class as
 * it does not provide communications ability, but it does assist with query string formatting.
 * </p>
 * <p>
 * UTF-8 encoding is used by default for % encoded characters. This may be overridden with the
 * org.eclipse.jetty.util.URI.charset system property.
 * </p>
 *
 * @see UrlEncoded
 */
    ...
    implements Cloneable
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Encode a URI path. This is the same encoding offered by URLEncoder, except that the '/' character is
     * not encoded.
     *
 ...
 /* Decode a URI path and strip parameters of ISO-8859-1 path
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add two URI path segments. Handles null and empty paths, path and query params (eg ?a=b or
    ...
    /* ------------------------------------------------------------ */
    /**
     * Convert a path to a cananonical form. All instances of "." and ".." are factored out. Null is returned
