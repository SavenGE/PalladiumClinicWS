...
/* ------------------------------------------------------------ */
/**
 * ShutdownThread is a shutdown hook thread implemented as singleton that maintains a list of lifecycle
 * instances that are registered with it and provides ability to stop these lifecycles upon shutdown of the
