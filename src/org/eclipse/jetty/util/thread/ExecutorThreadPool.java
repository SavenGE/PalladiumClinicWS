...
/* ------------------------------------------------------------ */
/**
 * Jetty ThreadPool using java 5 ThreadPoolExecutor This class wraps a {@link ExecutorService} as a
 * {@link ThreadPool} and {@link LifeCycle} interfaces so that it may be used by the Jetty
 * <code>org.eclipse.jetty.server.Server</code>
 */
public class ExecutorThreadPool extends AbstractLifeCycle implements ThreadPool, LifeCycle
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Wraps an {@link ThreadPoolExecutor}. Max pool size is 256, pool thread timeout after 60 seconds and an
     * unbounded {@link LinkedBlockingQueue} is used for the job queue;
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Wraps an {@link ThreadPoolExecutor}. Max pool size is 256, pool thread timeout after 60 seconds, and
     * core pool size is 32 when queueSize &gt;= 0.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Wraps an {@link ThreadPoolExecutor} using an unbounded {@link LinkedBlockingQueue} is used for the jobs
     * queue;
     *
