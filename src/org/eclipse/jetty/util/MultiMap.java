...
public class MultiMap<V> extends HashMap<String, List<V>>
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Get value as String. Single valued items are converted to a String with the toString() Object method.
     * Multi valued entries are converted to a comma separated List. No quoting of commas within values is
     * performed.
     *
     * @param name The entry key.
     * @return String value.
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add value to multi valued entry. If the entry is single valued, it is converted to the first value of a
     * multi valued entry.
     *
     * @param name The entry key.
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add values to multi valued entry. If the entry is single valued, it is converted to the first value of
     ...
     * @return true if an existing key was merged with potentially new values, false if either no change was
     * made, or there were only new keys.
     */
