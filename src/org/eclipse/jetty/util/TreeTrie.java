 ...
 * <p>
 * This implementation is always case insensitive and is optimal for a variable number of fixed strings with
 ...
 * for an TreeTrie to be built by a single thread and then used concurrently by multiple threads and not
