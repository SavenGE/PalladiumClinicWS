...
/* ======================================================================== */
/**
 * IO Utilities. Provides stream handling utilities in singleton Threadpool implementation accessed by static
 * members.
 */
public class IO
{
 ...
 /* 
     ...
     * @return true if anything was deleted. (note: this does not mean that all content in a directory was
     * deleted)
     */
