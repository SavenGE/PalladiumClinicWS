 ...
 *
 * These string utilities provide both convenience methods and performance improvements over most standard
 * library versions. The main aim of the optimizations is to avoid object creation unless absolutely required.
 *
 *
 */
public class StringUtil
{
     ...
     * @return true if string is null or only whitespace characters, false if non-whitespace characters
     * encountered.
     */
     ...
     *
     * @param str the string to test.
     * @return true if string is not null and has at least 1 non-whitespace character, false if null or
    ...
    /**
     * Convert String to an integer. Parses up to the first non-numeric character. If no number is found an
    ...
    /**
     * Convert String to an long. Parses up to the first non-numeric character. If no number is found an
     * IllegalArgumentException is thrown
     *
     * @param string A String containing an integer.
     * @return an int
     ...
     * @return the truncated string. if <code>str</code> param is null, then the returned string will also be
     * null.
     */
     ...
     * <p>
     * Handle <a href="https://www.ietf.org/rfc/rfc4180.txt">rfc4180</a>-like CSV strings, with the
     * exceptions:<ul>
     ...
     * <p>
     * This method calls {@link String#valueOf(Object)} unless the object is null, in which case null is
     * returned</p>
     *
