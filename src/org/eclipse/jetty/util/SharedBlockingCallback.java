...
/**
 * Provides a reusable {@link Callback} that can block the thread while waiting to be completed.
 * <p>
...
public class SharedBlockingCallback
{
    ...
    public class Blocker implements Callback.NonBlocking, Closeable
    {
        ...
        /**
         * Block until the Callback has succeeded or failed and after the return leave in the state to allow
         * reuse. This is useful for code that wants to repeatable use a FutureCallback to convert an
         * asynchronous API to a blocking API.
         *
