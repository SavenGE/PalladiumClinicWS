...
/**
 * A try-with-resources compatible layer for {@link StdErrLog#setHideStacks(boolean) hiding stacktraces}
 * within the scope of the <code>try</code> block when logging with {@link StdErrLog} implementation.
 * <p>
