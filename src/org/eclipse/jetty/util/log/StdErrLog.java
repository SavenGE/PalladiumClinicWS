 ...
 * <dd>indicates that all of the jetty specific classes, in any package that starts with
 * <code>org.eclipse.jetty</code> should log at level WARN.</dd>
 * <dt>org.eclipse.jetty.io.ChannelEndPoint.LEVEL=ALL</dt>
 * <dd>indicates that the specific class, ChannelEndPoint, should log all logging events that it can generate,
 * including DEBUG, INFO, WARN (and even special internally ignored exception cases).</dd>
 * </dl>
 * </dd>
 *
 * <dt>${name}.SOURCE=(true|false)</dt>
 * <dd>
 * Logger specific, attempt to print the java source file name and line number where the logging event
 * originated from.<br>
 * Name must be a fully qualified class name (package name hierarchy is not supported by this
 * configurable)<br>
 ...
 * <dd>Special Global Configuration, attempt to print the java source file name and line number where the
 * logging event originated from.<br>
 * Default: false
 * </dd>
 *
 * <dt>org.eclipse.jetty.util.log.stderr.LONG=(true|false)</dt>
 * <dd>Special Global Configuration, when true, output logging events to STDERR using long form, fully
 * qualified class names. when false, use abbreviated package names<br>
 * Default: false
 * </dd>
 * <dt>org.eclipse.jetty.util.log.stderr.ESCAPE=(true|false)</dt>
 * <dd>Global Configuration, when true output logging events to STDERR are always escaped so that control
 * characters are replaced with '?"; '\r' with '&lt;' and '\n' replaced '|'<br>
 * Default: true
 * </dd>
 * </dl>
 */
...
public class StdErrLog extends AbstractLogger
{
    ...
    /**
     * Obtain a StdErrLog reference for the specified class, a convenience method used most often during
     * testing to allow for control over a specific logger.
     * <p>
    ...
    /**
     * Get the Logging Level for the provided log name. Using the FQCN first, then each package segment from
     * longest to shortest.
     *
    ...
    /**
     * Legacy interface where a programmatic configuration of the logger level is done as a wholesale
     * approach.
     */
    @Override
