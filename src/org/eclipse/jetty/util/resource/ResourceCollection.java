...
/**
 * A collection of resources (dirs). Allows webapps to have multiple (static) sources. The first resource in
 * the collection is the main resource. If a resource is not found in the main resource, it looks it up in the
 * order the resources were constructed.
 *
 *
 *
 */
public class ResourceCollection extends Resource
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Sets the resources as string of comma-separated values. This method should be used when configuring
     * jetty-maven-plugin.
     *
