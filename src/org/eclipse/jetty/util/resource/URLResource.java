...
public class URLResource extends Resource
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Returns true if the represented resource is a container/directory. If the resource is not a file,
    ...
    /* ------------------------------------------------------------ */
    /**
     * Returns an input stream to the resource. The underlying url connection will be nulled out to prevent
     * re-use.
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * Returns an input stream to the resource, optionally nulling out the underlying url connection. If the
     * connection is not nulled out, a subsequent call to getInputStream() may return an existing and already
     * in-use input stream - this depends on the url protocol. Eg JarURLConnection does not reuse
     * inputstreams.
     *
