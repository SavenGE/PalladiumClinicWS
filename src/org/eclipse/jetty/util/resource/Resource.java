 ...
 * <p>
 * This class provides a resource abstraction, where a resource may be a file, a URL or an entry in a jar
 * file.
 * </p>
 */
public abstract class Resource implements ResourceFactory, Closeable
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Construct a system resource from a string. The resource is tried as classloader resource before being
    ...
    /* ------------------------------------------------------------ */
    /**
     * Find a classpath resource. The {@link java.lang.Class#getResource(String)} method is used to lookup the
     * resource. If it is not found, then the {@link Loader#getResource(Class, String)} method is used. If it
     * is still not found, then {@link ClassLoader#getSystemResource(String)} is used. Unlike
     * {@link ClassLoader#getSystemResource(String)} this method does not check for normal resources.
     *
     * @param name The relative name of the resource
     * @param useCaches True if URL caches are to be used.
     * @param checkParents True if forced searching of parent Classloaders is performed to work around loaders
     * with inverted priorities
     * @return Resource or null
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return true if the represented resource is a container/directory. if the resource is not a file,
     * resources ending with "/" are considered directories.
     */
     ...
     *
     * @return an File representing the given resource or NULL if this is not possible.
     ...
     *
     * @return true if resource was found and successfully deleted, false if resource didn't exist or was
     ...
     * @return true if the resource was renamed, false if the resource didn't exist or was unable to be
     * renamed.
     ...
     *
     * @return a list of resource names contained in the given resource. Note: The resource names are not URL
     * encoded.
     */
     ...
     * @throws MalformedURLException if the resolution of the path fails because the input path parameter is
     * malformed.
     */
     ...
     * <p>
     * This method is essentially an alias for {@link #addPath(String)}, but without checked exceptions. This
     * method satisfied the {@link ResourceFactory} interface.
     *
     ...
     *
     * The above example would parse incorrectly on various browsers as the "<" or '"' characters would end
     * the href attribute value string prematurely.
     *
