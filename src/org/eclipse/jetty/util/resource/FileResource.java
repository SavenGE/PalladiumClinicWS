 ...
 * File Resource.
 *
 * Handle resources of implied or explicit file type. This class can check for aliasing in the filesystem (eg
 * case insensitivity). By default this is turned on, or it can be controlled by calling the static method
 * @see FileResource#setCheckAliases(boolean)
 *
...
public class FileResource extends Resource
{
     ...
     * @return <code>true</code> of the object <code>o</code> is a {@link FileResource} pointing to the same
     * file as this resource.
     */
    @Override
