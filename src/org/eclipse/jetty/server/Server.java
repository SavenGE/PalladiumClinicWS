...
/* ------------------------------------------------------------ */
/**
 * Jetty HTTP Servlet Server. This class is the main class for the Jetty HTTP Servlet server. It aggregates
 * Connectors (HTTP request receivers) and request Handlers. The server is itself a handler and a ThreadPool.
 * Connectors use the ThreadPool methods to run jobs that will eventually call the handle method.
 */
...
public class Server extends HandlerWrapper implements Attributes
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Convenience constructor Creates server and a {@link ServerConnector} at the passed port.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set a graceful stop time. The {@link StatisticsHandler} must be configured so that open connections can
     ...
     *
     * @param stop If true, this server instance will be explicitly stopped when the JVM is shutdown.
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the connectors for this server. Each connector has this server set as it's ThreadPool and its
     * Handler.
     *
    ...
    protected void doStart() throws Exception
    {
        ...
        _connectors.stream().forEach((connector)
            -> 
            {
                try
                {
