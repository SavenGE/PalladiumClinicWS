...
public abstract class AbstractSession implements AbstractSessionManager.SessionIf
{
 ...
 /*
    ...
    /* ------------------------------------------------------------ */
    /**
     * Either set (perhaps replace) or remove the value of the attribute in the session. The appropriate
     * session attribute listeners are also called.
     *
     * @param name the name of the attribute
     * @param value the value of the attribute
    ...
    /* ------------------------------------------------------------- */
    /**
     * Unbind value if value implements {@link HttpSessionBindingListener} (calls
