...
public abstract class AbstractSessionIdManager extends AbstractLifeCycle implements SessionIdManager
{
    ...
    /* ------------------------------------------------------------ */
    /**
     * Get the workname. If set, the workername is dot appended to the session ID and can be used to assist
     * session affinity in a load balancer.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the workername. If set, the workername is dot appended to the session ID and can be used to assist
     * session affinity in a load balancer. A worker name starting with $ is used as a request attribute name
     * to lookup the worker name that can be dynamically set by a request Customizer.
     *
     ...
     *
     * @param reseed If non zero then when a random long modulo the reseed value == 1, the
     * {@link SecureRandom} will be reseeded.
     */
     ...
     *
     * @see org.eclipse.jetty.server.SessionIdManager#newSessionId(javax.servlet.http.HttpServletRequest,
     * long)
     */
    @Override
