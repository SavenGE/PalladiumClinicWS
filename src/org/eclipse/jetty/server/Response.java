...
/**
 * <p>
 * {@link Response} provides the implementation for {@link HttpServletResponse}.</p>
 */
public class Response implements HttpServletResponse
{
    ...
    /**
     * If a header name starts with this string, the header (stripped of the prefix) can be set during include
     * using only {@link #setHeader(String, String)} or {@link #addHeader(String, String)}.
     */
    public final static String SET_INCLUDE_HEADER_PREFIX = "org.eclipse.jetty.server.include.";

    /**
     * If this string is found within the comment of a cookie added with {@link #addCookie(Cookie)}, then the
     * cookie will be set as HTTP ONLY.
     */
     ...
     * request has a Expect header starting with 102, then a 102 response is sent. This indicates that the
     * request still be processed and real response can still be sent. This method is called by sendError if
     * it is passed 102.
     *
    ...
    /**
     * Get the MetaData.Response committed for this response. This may differ from the meta data in this
     * response for exceptional responses (eg 4xx and 5xx responses generated by the container) and the
     * committedMetaData should be used for logging purposes.
     *
     * @return The committed MetaData or a {@link #newResponseMetaData()} if not yet committed.
     */
