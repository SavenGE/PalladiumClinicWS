 ...
 * and the Combined Log Format (single log format). This log format can be output by most web servers, and
 * almost all web log analysis software can understand these formats.
 */
public abstract class AbstractNCSARequestLog extends AbstractLifeCycle implements RequestLog
{
     ...
     *
     * @param logCookies true - values of request cookies will be logged, false - values of request cookies
     * will not be logged
     */
     ...
     *
     * @param logLatency true - request processing time will be logged false - request processing time will
     * not be logged
     */
    ...
    /**
     * Controls whether the actual IP address of the connection or the IP address from the X-Forwarded-For
     * header will be logged.
     *
     * @param preferProxiedForAddress true - IP address from header will be logged, false - IP address from
     ...
     *
     * @param extended true - log the extended request information, false - do not log the extended request
     * information
     */
    ...
    /**
     * Set the timestamp format for request log entries in the file. If this is not set, the pre-formated
