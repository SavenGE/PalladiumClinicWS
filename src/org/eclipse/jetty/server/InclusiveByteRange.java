 ...
 * <p>
 * And yes the spec does strangely say that while 10-20, is bytes 10 to 20 and 10- is bytes 10 until the end
 * that -20 IS NOT bytes 0-20, but the last 20 bytes of the content.
 *
 * @version $version$
 *
 */
