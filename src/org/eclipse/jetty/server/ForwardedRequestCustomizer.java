 ...
 * <p>
 * This customizer looks at at HTTP request for headers that indicate it has been forwarded by one or more
 * proxies. Specifically handled are:
 * <ul>
 ...
 * </ul>
 * <p>
 * If these headers are present, then the {@link Request} object is updated so that the proxy is not seen as
 * the other end point of the connection on which the request came</p>
 * <p>
 * Headers can also be defined so that forwarded SSL Session IDs and Cipher suites may be customised</p>
 *
...
public class ForwardedRequestCustomizer implements Customizer
{
     ...
     * {@link ServletRequest#getServerName()} and {@link ServletRequest#getServerPort()}.
     *
