 ...
 * </ul>
 *
 * Handlers are passed the servlet API request and response object, but are not Servlets. The servlet
 * container is implemented by handlers for context, security, session and servlet that modify the request
 * object before passing it to the next stage of handling.
 *
 */
