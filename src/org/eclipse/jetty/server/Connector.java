...
/**
 * <p>
 * A {@link Connector} accept connections and data from remote peers, and allows applications to send data to
 * remote peers, by setting up the machinery needed to handle such tasks.</p>
 */
...
public interface Connector extends LifeCycle, Graceful
{
     ...
     * <p>
     * A {@link ContextHandler} may be configured with virtual hosts in the form "@connectorName" and will
     * only serve requests from the named connector.
     *
