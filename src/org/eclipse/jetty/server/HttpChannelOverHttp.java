...
class HttpChannelOverHttp extends HttpChannel implements HttpParser.RequestHandler
{
     ...
     * <p>
     * The upgrade looks up a {@link ConnectionFactory.Upgrading} from the connector matching the protocol
     * specified in the {@code Upgrade} header.</p>
     * <p>
     * The upgrade may succeed, be ignored (which can allow a later handler to implement) or fail with a
     * {@link BadMessageException}.</p>
     *
