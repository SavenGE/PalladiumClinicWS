...
/* ------------------------------------------------------------ */
/**
 * Customizer that extracts the attribute from an {@link SSLContext} and sets them on the request with
 * {@link ServletRequest#setAttribute(String, Object)} according to Servlet Specification Requirements.
 */
public class SecureRequestCustomizer implements HttpConfiguration.Customizer
{
 ...
 /* ------------------------------------------------------------ */
    /**
     * Simple bundle of information that is cached in the SSLSession. Stores the effective keySize and the
