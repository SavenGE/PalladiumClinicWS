 ...
 * <p>
 * Provides the common handling for {@link ConnectionFactory} implementations including:<ul>
 * <li>Protocol identification
 * <li>Configuration of new Connections:<ul>
 * <li>Setting inputbuffer size
 * <li>Calling {@link Connection#addListener(Connection.Listener)} for all Connection.Listener instances found
 * as beans on the {@link Connector} and this {@link ConnectionFactory}
 * </ul>
 * </ul>
 */
