 ...
 * {@link org.eclipse.jetty.server.Server#addBean(Object)}. It is called by the HttpResponse.sendError method
 * to write a error page via {@link #handle(String, Request, HttpServletRequest, HttpServletResponse)} or via
 * {@link #badMessageError(int, String, HttpFields)} for bad requests for which a dispatch cannot be done.
 *
 */
public class ErrorHandler extends AbstractHandler
{
 ...
 /*
     ...
     * <p>
     * Generate a error response body to be sent for a bad message. In this case there is something wrong with
     * the request, so either a request cannot be built, or it is not safe to build a request. This method
     * allows for a simple error page body to be returned and some response headers to be set.
     *
