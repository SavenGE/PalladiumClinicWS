 ...
 * Resource Handler.
 *
 * This handle will serve static content and handle If-Modified-Since headers. No caching is done. Requests
 * for resources that do not exist are let pass (Eg no 404's).
 *
 *
 */
public class ResourceHandler extends HandlerWrapper
{
     ...
     *
     * @return the minimum size in bytes of a file resource that will be served using a memory mapped buffer,
     * or -1 (default) for no memory mapped buffers.
     */
     ...
     *
     * @param minMemoryMappedFileSize the minimum size in bytes of a file resource that will be served using a
     * memory mapped buffer, or -1 for no memory mapped buffers.
     */
     ...
     *
     * @return The minimum size in bytes of the content before asynchronous handling is used, or -1 for no
     * async handling or 0 (default) for using {@link HttpServletResponse#getBufferSize()} as the minimum
     * length.
     */
     ...
     *
     * @param minAsyncContentLength The minimum size in bytes of the content before asynchronous handling is
     * used, or -1 for no async handling or 0 for using {@link HttpServletResponse#getBufferSize()} as the
     * minimum length.
     */
 ...
 /*
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the response headers. This method is called to set the response headers such as content type and
     * content length. May be extended to add additional headers.
     *
