...
/* ------------------------------------------------------------ */
/**
 * Moved ContextHandler. This context can be used to replace a context that has changed location. Requests are
 * redirected (either to a fixed URL or to a new context base).
 */
