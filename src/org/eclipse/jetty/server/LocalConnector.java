...
public class LocalConnector extends AbstractConnector
{
    ...
    /**
     * Sends requests and get responses based on thread activity. Returns all the responses received once the
     * thread activity has returned to the level it was before the requests.
     * <p>
    ...
    /**
     * Sends requests and get's responses based on thread activity. Returns all the responses received once
