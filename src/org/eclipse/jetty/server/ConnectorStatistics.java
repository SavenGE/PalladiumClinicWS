...
/* ------------------------------------------------------------ */
/**
 * A Connector.Listener that gathers Connector and Connections Statistics. Adding an instance of this class as
 * with {@link AbstractConnector#addBean(Object)} will register the listener with all connections accepted by
 * that connector.
 */
