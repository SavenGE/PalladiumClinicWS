 ...
 * Cookie parser
 * <p>
 * Optimized stateful cookie parser. Cookies fields are added with the {@link #addCookieField(String)} method
 * and parsed on the next subsequent call to {@link #getCookies()}. If the added fields are identical to those
 * last added (as strings), then the cookies are not re parsed.
 *
 *
 */
