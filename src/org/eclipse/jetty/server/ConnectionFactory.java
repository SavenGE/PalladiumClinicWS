 ...
 * <p>
 * A Connection factory is responsible for instantiating and configuring a {@link Connection} instance to
 * handle an {@link EndPoint} accepted by a {@link Connector}.
 * <p>
 * A ConnectionFactory has a protocol name that represents the protocol of the Connections created. Example of
 * protocol names include:
 * <dl>
...
public interface ConnectionFactory
{
    ...
    public interface Upgrading extends ConnectionFactory
    {
         ...
         * <p>
         * This is a variation of {@link #newConnection(Connector, EndPoint)} that can create (and/or
         * customise) a connection for an upgrade request. Implementations may call
         * {@link #newConnection(Connector, EndPoint)} or may construct the connection instance
         * themselves.</p>
         *
         ...
         * @return Null to indicate that request processing should continue normally without upgrading. A new
         * connection instance to indicate that the upgrade should proceed.
         * @throws BadMessageException Thrown to indicate the upgrade attempt was illegal and that a bad
         * message response should be sent.
         */
