...
public interface SessionManager extends LifeCycle
{
    /* ------------------------------------------------------------ */
    /**
     * Session cookie name. Defaults to <code>JSESSIONID</code>, but can be set with the
    ...
    /* ------------------------------------------------------------ */
    /**
     * Session id path parameter name. Defaults to <code>jsessionid</code>, but can be set with the
     * <code>org.eclipse.jetty.servlet.SessionIdPathParameterName</code> context init parameter. If set to
    ...
    /* ------------------------------------------------------------ */
    /**
     * Session Domain. If this property is set as a ServletContext InitParam, then it is used as the domain
     * for session cookies. If it is not set, then no domain is specified for the session cookie.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Session Path. If this property is set as a ServletContext InitParam, then it is used as the path for
     * the session cookie. If it is not set, then the context path is used as the path for the cookie.
     */
     ...
     * @return the <code>HttpSession</code> with the corresponding id or null if no session with the given id
     * exists
     */
     ...
     *
     * @param listener the session event listener to add Individual SessionManagers implementations may accept
     * arbitrary listener types, but they are expected to at least handle HttpSessionActivationListener,
     ...
     * @param contextPath the context to which the cookie should be linked. The client will only send the
     * cookie value when requesting resources under this path.
     ...
     *
     * @param parameterName the URL path parameter name for session id URL rewriting (null or "none" for no
     * rewriting).
