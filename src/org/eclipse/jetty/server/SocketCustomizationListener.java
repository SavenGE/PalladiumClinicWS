 ...
 * <p>
 * Instances of this listener may be added to a {@link Connector} (or {@link ConnectionFactory}) so that they
 * are applied to all connections for that connector (or protocol) and thus allow additional Socket
...
public class SocketCustomizationListener implements Listener
{
    ...
    /**
     * @param ssl If True, then a Socket underlying an SSLConnection is unwrapped and notified.
     */
     ...
     * @param connection The class of the connection (The socket may be wrapped by an {@link SslConnection}
