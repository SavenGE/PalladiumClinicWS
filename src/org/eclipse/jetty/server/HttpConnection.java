...
public class HttpConnection extends AbstractConnection implements Runnable, HttpTransport, Connection.UpgradeFrom
{
    ...
    /**
     * Get the current connection that this thread is dispatched to. Note that a thread may be processing a
     * request asynchronously and thus not be dispatched to the connection.
     *
